...
class Parque {
  ...
  private:
    int fase(const int** espera, int m, int n, const int* disfrute, const int** traslado, int suma, int nvisitados, std::vector<int> sigma, int i, int j, vector<int> &solucion);
    Datos d;
    int Te=0;
    int Ts=0;
    int sizeSol = 0;
